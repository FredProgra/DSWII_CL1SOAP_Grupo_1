 ...
 *       &lt;sequence&gt;
 *         &lt;element name="autor" type="{http://www.cibertec.edu.pe/ws/objects}autorws" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAutoresResponse {
     ...
     * 
     */
    public List<Autorws> getAutor() {
        if (autor == null) {
            autor = new ArrayList<Autorws>();
        }
        return this.autor;
    }
